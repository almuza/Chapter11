...
{
    [super viewDidLoad];
    _swAscending.hidden = YES;
	// Do any additional setup after loading the view.
    sortOrderItems = @[@"Name", @"City", @"Birthday", @"Email", @"Home Number", @"State", @"Street Address"];
...
{
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    [defaults setBool:_orderSegment.selectedSegmentIndex == 0 forKey:kSortDirectionAscending];
}
@end
